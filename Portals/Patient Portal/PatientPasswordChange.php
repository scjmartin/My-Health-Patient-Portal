<!DOCTYPE html>
  ...
  <body>
    ...
    <li class="nav-item">
        <a class="nav-link" href="/Project/PatientPortal/PatientLandingg.php">Home</a>
      </li>
      <li class="nav-item">
...
$sql = "UPDATE db1.Patients SET Password = '$password1' WHERE Patients.PatientID='$PID'";
